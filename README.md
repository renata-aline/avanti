...
Este projeto é o resultado do desafio final de front-end, onde o objetivo foi reproduzir fielmente um layout do Figma utilizando **HTML**, **CSS/SCSS** e **JavaScript**, com foco em responsividade, boas práticas e interatividade.
---
